...
void personaje::mover(){
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::Left)){
        x-=60;
        if(x>0&&(x==60 || x==180 || x==300 || x==420 || x==540 || x==660 || x==780 || y==60 || y==180||y==300 || y==420 || y==540)){
        ...
        x+=60;
        if(x<840&&(x==60 || x==180 || x==300 || x==420 || x==540 || x==660 || x==780 || y==60 || y==180||y==300 || y==420 || y==540) ){
            std::cout<<x<<","<<y<<std::endl;
            this->move(60, 0);
            Sleep(150);
        ...
        y-=60;
        if(y>0 &&(x==60 || x==180 || x==300 || x==420 || x==540 || x==660 || x==780 || y==60 || y==180||y==300 || y==420 || y==540)){
            std::cout<<x<<","<<y<<std::endl;
            this->move(0, -60);
            Sleep(150);
        ...
        y+=60;
        if(y<600 &&(x==60 || x==180 || x==300 || x==420 || x==540 || x==660 || x==780 || y==60 || y==180||y==300 || y==420 || y==540)){
            std::cout<<x<<","<<y<<std::endl;
            this->move(0, 60);
            Sleep(150);
